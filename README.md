...
<body>
    <div class="app-container">
        ...
        <div class="input-container">
            <div class="input-box">
                <label for="ml1">Mililitros / Onzas</label>
            ...
            <div class="input-box">
                <label>
                    <input type="checkbox" id="onzasCheckbox">
                    Convertir de onzas a mililitros
                </label>
            </div>
        </div>
    ...
    <script>
        function calcularPrecioPorLitro() {
            ...
            const onzasCheckbox = document.getElementById('onzasCheckbox').checked;

            // Si el checkbox está marcado, convertir onzas a mililitros
            if (onzasCheckbox) {
                ml1 = ml1 * 29.5735; // 1 onza = 29.5735 mililitros
            }
